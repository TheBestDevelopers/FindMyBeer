...
@Entity
@GenericGenerator(name = "seq1", strategy = "sequence-identity", parameters = @org.hibernate.annotations.Parameter(name = "convenience_id_sequence", value = "convenience_id_sequence"))
