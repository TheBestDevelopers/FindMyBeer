 ...
 */
@Entity
@GenericGenerator(name = "seq4", strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator", parameters = @org.hibernate.annotations.Parameter(name = "menu_id_sequence", value = "menu_id_sequence"))
