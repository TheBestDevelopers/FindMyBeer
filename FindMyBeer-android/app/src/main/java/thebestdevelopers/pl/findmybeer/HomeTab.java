...
//PRZEKOPIOWANE Z MAPY BEZPOSREDNIO
...
import thebestdevelopers.pl.findmybeer.pubList.GetNearbyPubs;
...
public class HomeTab extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    public void onClick(View v) {
       // mGoogleMap.clear();
        ...
        if (latitude!= 0.0 && longitude!=0.0) {
            ...
            GetNearbyPubs getNearbyPlacesData = new GetNearbyPubs(pubs);
            ...
            if (pubs != null) {
                Toast.makeText(this, "places list size: " + nearbyPlaceList.size(), Toast.LENGTH_SHORT).show();
            } else {
    ...
    private void initializePubs() {
        pubs = new ArrayList<>();
        pubs.add(new Pub("sruba", 200.0, 4, 4.5));
    }
...
//        String url = getUrl(latitude, longitude, "pub");
//        dataTransfer[0] = url;
//        GetNearbyPubs getPubListElement =  new GetNearbyPubs(this);
